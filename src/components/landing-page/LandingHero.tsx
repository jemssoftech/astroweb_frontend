      ...
      <div className="container xl:max-w-[1440px] mx-auto px-6 relative z-10 w-full mb-12">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8  mx-auto">
          ...
          <div className="flex-1 w-full max-w-[550px] pt-10 lg:pt-0 z-10">
            {/* Tag */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#1A1A24]/60 border border-[#2D1B4E]/50 text-[#A855F7] text-[9px] font-bold tracking-widest mb-6 backdrop-blur-sm shadow-[0_0_10px_rgba(45,27,78,0.2)]">
              <div className="w-1.5 h-1.5 rounded-full bg-[#A855F7] shadow-[0_0_5px_#A855F7]"></div>
            ...
            <h1 className="text-[3.2rem] sm:text-[4.2rem] lg:text-[68px] font-bold text-white mb-6 tracking-tight leading-[1.05]">
              <span className="bg-clip-text text-transparent bg-gradient-to-br from-purple-400 via-fuchsia-400 to-pink-400 pb-1 inline-block">
                All-in-One <br />
                Astrology
              </span>{" "}
              <br />
            ...
            <div className="flex flex-wrap items-center gap-4 mb-14">
              <button className="flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-br from-violet-600 to-purple-500 hover:from-violet-500 hover:to-purple-400  duration-300 text-white rounded-xl text-[14px] font-bold transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:scale-[1.02]">
                <Iconify icon="ph:sparkle-fill" className="text-lg" />
                Get Early Access
              </button>
              <button className="flex items-center justify-center gap-2 px-6 py-3.5 bg-[#111116]/80 backdrop-blur-md border border-white/10 text-white rounded-xl text-[14px] font-bold transition-all hover:bg-[#1A1A24] hover:border-white/20 hover:scale-[1.02]">
                <Iconify
                  icon="ph:users-three"
            ...
            <div className="flex items-center border border-white/5 rounded-2xl bg-[#09090D]/80 backdrop-blur-md max-w-[480px]">
              <div className="flex-1 py-6 px-4 text-center border-r border-white/5">
                <div className="text-2xl font-bold text-[#F472B6] mb-1.5 tracking-tight">
                  0+
                </div>
          ...
          <div className="flex-1 flex justify-center items-center relative w-full h-[500px] lg:h-[700px] mt-10 lg:mt-0">
            <div className="relative w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] flex items-center justify-center">
              ...
              <div className="absolute inset-[26%] rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(192,132,252,0.4),rgba(124,58,237,0.25)_40%,rgba(4,5,13,0.9)_80%)] border border-[rgba(168,85,247,0.3)] overflow-hidden backdrop-blur-2xl shadow-[0_0_80px_rgba(124,58,237,0.4),0_0_160px_rgba(124,58,237,0.15),inset_0_0_40px_rgba(168,85,247,0.1)] ">
                <img
                ...
                <div className="absolute flex flex-col items-center justify-center inset-0 gap-3">
                  ...
                  <div className="text-[10px] text-[rgba(168,85,247,0.7)] tracking-[0.2em] uppercase mt-6 font-semibold">
                    Oracle
                  </div>
                </div>
              </div>
              ...
              {/* Card 1: Birth Charts */}
              <div className="absolute top-[15%] left-[-20%] lg:left-[-15%] bg-[#0A0A0E]/90 backdrop-blur-xl border border-white/5 p-4 rounded-2xl w-48 shadow-2xl z-20">
              ...
              <div className="absolute top-[45%] right-[-25%] lg:right-[-20%] bg-[#0A0A0E]/90 backdrop-blur-xl border border-white/5 p-4 rounded-2xl w-48 shadow-2xl z-20">
              ...
              <div className="absolute bottom-[5%] right-[-10%] lg:right-[-5%] bg-[#0A0A0E]/90 backdrop-blur-xl border border-white/5 p-4 rounded-2xl w-48 shadow-2xl z-20">
              ...
              <div className="absolute top-[35%] left-[0%] w-6 h-6 rounded-md bg-[#1B112C] border border-white/5 flex items-center justify-center z-10">
                <Iconify
                  ...
                  className="text-[#A855F7]/80 text-[10px]"
                />
              </div>
